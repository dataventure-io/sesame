...
void md5(MD5_HASH* msg_hash, uint8_t *initial_msg, size_t initial_len) {
    ...
    msg_hash->h0 = 0x67452301;
    msg_hash->h1 = 0xefcdab89;
    msg_hash->h2 = 0x98badcfe;
    msg_hash->h3 = 0x10325476;
    ...
    for(offset=0; offset<new_len; offset += (512/8)) {
        ...
        uint32_t a = msg_hash->h0;
        uint32_t b = msg_hash->h1;
        uint32_t c = msg_hash->h2;
        uint32_t d = msg_hash->h3;
